...
_KRENATSMESSAGE_TRACKING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="node_name",
            full_name="KreNatsMessage.Tracking.node_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="start",
            full_name="KreNatsMessage.Tracking.start",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="end",
            full_name="KreNatsMessage.Tracking.end",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_KRENATSMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="tracking_id",
            full_name="KreNatsMessage.tracking_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="reply",
            full_name="KreNatsMessage.reply",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="payload",
            full_name="KreNatsMessage.payload",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="error",
            full_name="KreNatsMessage.error",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="replied",
            full_name="KreNatsMessage.replied",
            index=5,
            number=6,
            type=8,
            cpp_type=7,
