...
func (m *MockKRTRepository) DownloadKRT(versionID string) (io.Reader, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DownloadKRT", versionID)
...
func (mr *MockKRTRepositoryMockRecorder) DownloadKRT(versionID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DownloadKRT", reflect.TypeOf((*MockKRTRepository)(nil).DownloadKRT), versionID)
}
