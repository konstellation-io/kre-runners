...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x12kre_nats_msg.proto\x12\x05proto\x1a\x19google/protobuf/any.proto\"\xa5\x01\n\x0eKreNatsMessage\x12\x13\n\x0btracking_id\x18\x01 \x01(\t\x12\r\n\x05reply\x18\x03 \x01(\t\x12%\n\x07payload\x18\x04 \x01(\x0b\x32\x14.google.protobuf.Any\x12\r\n\x05\x65rror\x18\x05 \x01(\t\x12 \n\x18\x65ntrypointHasBeenReplied\x18\x06 \x01(\x08\x12\x17\n\x0f\x65ntrypointStart\x18\x07 \x01(\tB\x07Z\x05./kreb\x06proto3')
  ,
...
_KRENATSMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='reply', full_name='proto.KreNatsMessage.reply', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='payload', full_name='proto.KreNatsMessage.payload', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='proto.KreNatsMessage.error', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='entrypointHasBeenReplied', full_name='proto.KreNatsMessage.entrypointHasBeenReplied', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='entrypointStart', full_name='proto.KreNatsMessage.entrypointStart', index=5,
