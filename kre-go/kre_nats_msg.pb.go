...
const (
	...
	MessageType_EARLY_REPLY MessageType = 2
	MessageType_EARLY_EXIT  MessageType = 3
)
...
type KreNatsMessage struct {
	...
	Replied     bool                       `protobuf:"varint,6,opt,name=replied,proto3" json:"replied,omitempty"`                      // deprecate
	EarlyExit   bool                       `protobuf:"varint,7,opt,name=early_exit,json=earlyExit,proto3" json:"early_exit,omitempty"` // deprecate
	FromNode    string                     `protobuf:"bytes,8,opt,name=from_node,json=fromNode,proto3" json:"from_node,omitempty"`
	MessageType MessageType                `protobuf:"varint,9,opt,name=message_type,json=messageType,proto3,enum=MessageType" json:"message_type,omitempty"`
}
...
var file_kre_nats_msg_proto_rawDesc = []byte{
	...
	0xa4, 0x03, 0x0a, 0x0e, 0x4b, 0x72, 0x65, 0x4e, 0x61, 0x74, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0b, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x54, 0x79, 0x70, 0x65, 0x1a, 0x4f, 0x0a, 0x08, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x69, 0x6e,
	0x67, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	...
	0x09, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x2a, 0x41, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x06, 0x0a, 0x02, 0x4f, 0x4b, 0x10, 0x00, 0x12, 0x09, 0x0a,
	0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x01, 0x12, 0x0f, 0x0a, 0x0b, 0x45, 0x41, 0x52, 0x4c,
	0x59, 0x5f, 0x52, 0x45, 0x50, 0x4c, 0x59, 0x10, 0x02, 0x12, 0x0e, 0x0a, 0x0a, 0x45, 0x41, 0x52,
	0x4c, 0x59, 0x5f, 0x45, 0x58, 0x49, 0x54, 0x10, 0x03, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x6b,
...
var file_kre_nats_msg_proto_goTypes = []interface{}{
	...
	(*KreNatsMessage_Tracking)(nil), // 2: KreNatsMessage.Tracking
	(*anypb.Any)(nil),               // 3: google.protobuf.Any
}
var file_kre_nats_msg_proto_depIdxs = []int32{
	2, // 0: KreNatsMessage.tracking:type_name -> KreNatsMessage.Tracking
	3, // 1: KreNatsMessage.payload:type_name -> google.protobuf.Any
	0, // 2: KreNatsMessage.message_type:type_name -> MessageType
